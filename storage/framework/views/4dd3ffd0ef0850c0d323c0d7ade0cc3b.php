...
<div class="ui-block popup-chat popup-chat-responsive" tabindex="-1" role="dialog" aria-labelledby="update-header-photo" aria-hidden="true">
	<div class="modal-content">
		<div class="modal-header">
			...
			<div class="more">
				<svg class="olymp-little-delete js-chat-close"><use xlink:href="<?php echo e(asset('svg-icons/sprites/icons.svg#olymp-little-delete')); ?>"></use></svg>
			</div>
		</div>
...
<?php /**PATH C:\xampppp\htdocs\copysc\resources\views/partials/windows-popup/window-chat-responsive.blade.php ENDPATH**/ ?>