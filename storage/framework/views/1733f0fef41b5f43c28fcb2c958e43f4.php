...
<header class="header" id="site-header">
	<div class="fixed-sidebar">
		<a href="<?php echo e(route('home', ['id' => Auth::id()])); ?>" class="logo">
			<div class="img-wrap">
				<img src="<?php echo e(asset('images/logo.png')); ?>" alt="Olympus">
			</div>
		</a>
	</div>
	<div class="page-title">
		<h6><a href="<?php echo e(route('home', ['id' => Auth::id()])); ?>" class="logo">Trang chủ</a></h6>
	</div>

	<div class="header-content-wrapper">
		<form method="POST" action="<?php echo e(route('search')); ?>" class="search-bar w-search notification-list friend-requests">
    		<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    		<div class="form-group with-button">
        		<input name="search" class="form-control" placeholder="Tìm bạn bè..." type="text">
        		<button type="submit"> <svg class="olymp-magnifying-glass-icon"><use xlink:href="<?php echo e(asset('svg-icons/sprites/icons.svg#olymp-magnifying-glass-icon')); ?>"></use></svg>
        		</button>
    		</div>
		</form>
		...
		<div class="control-block">
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<a href="<?php echo e(route('friend_requests', ['id' => Auth::id()])); ?>" class="view-all bg-blue">Xem tất cả</a>
				</div>
			</div>
				...
				<div class="more-dropdown more-with-triangle triangle-top-center pb-0">
					...
					<div class="mCustomScrollbar" data-mcs-theme="dark">
						<ul class="notification-list chat-message ">
							<?php $__currentLoopData = $listMess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mess): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li>
									<div class="author-thumb">
										<img src="<?php echo e(asset($mess->profile->avatar_path)); ?>" alt="author" class="avatar">
									</div>
									<div class="notification-event">
			...
			<div class="author-page author vcard inline-items more">
				<div class="author-thumb">
					<a href="<?php echo e(route('profile', ['id' => Auth::id()])); ?>">
						<?php if(($profile->avatar_path) != null): ?>
							<img alt="author" src="<?php echo e(asset($profile->avatar_path)); ?>" width="36" height="36" class="avatar">
						<?php else: ?>
							<img alt="author" src="<?php echo e(asset('images/avatar67-sm.jpg')); ?>" width="36" height="36" class="avatar">
						<?php endif; ?>
					</a>
					<div class="more-dropdown more-with-triangle">
						<div class="mCustomScrollbar" data-mcs-theme="dark">
							...
							<ul class="account-settings">
								<li>
									<a href="<?php echo e(route('get_profile_update_info', ['id' => Auth::id()])); ?>">
								...
								<li>
									<a href="<?php echo e(route('logout')); ?>">
										<svg class="olymp-logout-icon"><use xlink:href="<?php echo e(asset('svg-icons/sprites/icons.svg#olymp-logout-icon')); ?>"></use></svg>
				...
				<!-- <a href="02-ProfilePage.html" class="author-name fn">
					<div class="author-title">
						James Spiegel <svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo e(asset('svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon')); ?>"></use></svg>
					</div>
					<span class="author-subtitle">SPACE COWBOY</span>
				</a> -->
				<a href="<?php echo e(route('profile', ['id' => Auth::id()])); ?>" class="author-name fn">
					<div class="author-title">
						<?php echo e(Auth::user()->first_name); ?><svg class="olymp-dropdown-arrow-icon"><use xlink:href="<?php echo e(asset('svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon')); ?>"></use></svg>
					</div>
					<!-- <span class="author-subtitle">SPACE COWBOY</span> -->
				</a>
			</div>
...
<!-- ... end Header-BP --><?php /**PATH C:\xampppp\htdocs\copysc\resources\views/partials/headers-navigations/header-BP.blade.php ENDPATH**/ ?>