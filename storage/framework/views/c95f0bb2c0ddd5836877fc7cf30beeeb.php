...
<div class="modal fade" id="update-header-photo" tabindex="-1" role="dialog" aria-labelledby="update-header-photo" aria-hidden="true">
	<div class="modal-dialog window-popup update-header-photo" role="document">
		<div class="modal-content">
			...
			<form method="POST" action="<?php echo e(route('update_header', ['id' => Auth::id()])); ?>" enctype="multipart/form-data">
...
<!-- ... end Window-popup Update Header Photo --><?php /**PATH C:\xampppp\htdocs\copysc\resources\views/partials/windows-popup/update-header-photo.blade.php ENDPATH**/ ?>